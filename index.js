window.addEventListener("load", function () {
  ...
  class InputHandler {
    constructor() {
      ...
      window.addEventListener("touchmove", (e) => {
        const swipeDistanse = e.changedTouches[0].pageY - this.touchY;
        if (
          swipeDistanse < this.touchTreshold &&
  ...
  class Player {
    ...
    update(input, deltaTime, enemies) {
      ...
      if (this.y > this.gameHeight - this.width)
  ...
  function handleEnemies(deltaTime) {
    ...
    enemies = enemies.filter((enemies) => !enemies.markedForDeletion);
  }
